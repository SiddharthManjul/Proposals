...
export function Footer() {
  return (
    <footer className="mt-20 border-t border-rule">
      ...
      <div className="mx-auto max-w-[1180px] px-6 lg:px-10 py-12">
        <div className="grid grid-cols-12 gap-8">
          <div className="col-span-12 md:col-span-4">
            ...
            <p className="mt-3 text-[14px] text-ink-soft max-w-[40ch] leading-relaxed">
              An archive of community proposals, debate, and decisions. Edited
              by builders, hosted in the open, read on weekends.
            </p>
          </div>
          ...
          <div className="col-span-12 md:col-span-2">
            ...
            <p className="text-[13px] text-ink-soft leading-relaxed">
              ...
              moderated by the community, not by the foundation.
            </p>
          </div>
        </div>
        <div className="mt-12 pt-6 border-t border-rule flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 font-mono text-[11px] uppercase tracking-[0.14em] text-ink-faint">
          <span>© {new Date().getFullYear()} The Monad Proposals Archive</span>
          <span>
