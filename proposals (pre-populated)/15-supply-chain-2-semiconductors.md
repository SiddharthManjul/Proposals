CATEGORY: SIP
TITLE: YC Summer 2026 RFS on Supply Chain 2.0 for Semiconductors: build the software the spreadsheets cannot
...
- Export-control complexity exploded with the U.S. Bureau of Industry and Security's published guidance on AI-chip-related controls (the `October 2022, October 2023and December 2024` rule expansions), the EU's parallel framework and Japan and Netherlands' bilateral controls. Semiconductor companies now require operational compliance tooling at a scale that didn't exist 24 months ago.
