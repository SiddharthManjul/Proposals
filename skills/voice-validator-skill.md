...
5. Run the **Section 7.3 structural scan**: three-sentence preamble before the point, closing summary paragraph, *Conclusion* heading, *Furthermore / Moreover / In conclusion* paragraph openers, triadic adjectives, round-numbered lists when the real count is 4 or 7, exclamation marks, emojis in body, em dashes (the `—` character, any use; flag every occurrence, structural or decorative), Oxford commas (a comma before the final *and* / *or* in a list of three or more items), heavy semicolon use (more than two semicolons in a tight 600–900 word proposal, or more than three in a medium 1200–1800 word proposal; semicolons used as em-dash substitutes are the typical AI-edit tell).
